...
my <- c(0.15, er)
ggplot()+
  geom_point(aes(A[1], A[2], color = 'Porfolio A'))+
  geom_point(aes(B[1], B[2], color = 'Portfolio B'))+
  geom_point(aes(C[1], C[2], color = 'Portfolio C'))+
  geom_point(aes(my[1], my[2], color = 'Alternative Portfolio'), size = 2)+
